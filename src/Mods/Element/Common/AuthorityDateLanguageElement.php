...
use Slub\Mods\Attribute\Common\DateAttribute;
 ...
 * @access public
 */
class AuthorityDateLanguageElement extends BaseElement
{
    use AuthorityAttribute, DateAttribute, LanguageAttribute;
